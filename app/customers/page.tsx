  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">{sampleCustomers.length} registered customers</p>
      </div>
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        <div className="relative">
          ...
          <input type="text" placeholder="Search name, email, city..." value={search} onChange={(e) => setSearch(e.target.value)} className="pl-10 pr-4 py-2 w-64 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-500" />
        </div>
      </div>
        ...
        {selected && (
          <div className="space-y-4">
            ...
            <div className="pt-4 border-t">
              <button className="px-4 py-2 bg-red-50 text-red-700 rounded-lg text-sm font-medium hover:bg-red-100">
                Deactivate Account
              </button>
            </div>
          </div>
